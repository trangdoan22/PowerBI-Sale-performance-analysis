...
**1. About products and product categories:**

- Bicycles accounts for the largest quantity and revenue (90268 products and about 94.65 million USD from 2011 -> 2014) in total sales and overwhelm the remaining 3 types of goods.
- Bicycle parts (components) accounts for the least quantity, but revenue ranked 2nd: 49044 products and about 12 million USD in revenue
- Clothes and accessories account for a large quantity (74K and 62K respectively) but the lowest revenue (only 1-2 million USD)
- Except for 2 best-sellers, Road Bike and Mountain Bike, the remaining items of all industry groups are not too different.
...
- Canadian market ranked the second, indexes are much lower than the first one (revenue 16.36 million USD, gross profit 8.44 million USD) but has the highest profit margin of all countries (51.61%)
=> potential market
- With the remaining markets (including Australia, UK, France, Germany), the revenue are almost the same, ranging from 5 million -> 10 million USD.
- However, especially, the profit margin in the Australian market is very low (only 6%).

**II. General analysis of additional metrics: Avg transaction size, revenue growth, quota attainment**

**1. Average transaction size:** 

In general, in terms of analysis by product or by geographical area, there is a strong downtrend in the period from 2011 to 2014 (about $2210/transaction -> $537.18 USD/transaction)
   
=> The average amount customers willing to pay for 1 transaction decreased from 2012 -> 2014

+ About product aspect:

The ratio of the average transaction size amongs products remains unchanged

While the average transaction size of 3 categories' : Bikes, Clothing and Components all tend to decrease, Accessories' tend to increase slightly from 2011 -> 2012 and then decrease.

+ In terms of geographical area: In the period from 2011 -> 2012, Australia took the lead in terms of average transaction size, but in the period from 2013 -> 2014 ranked the last
+ Seasonality: average transaction size tends to increase at the beginning of the year (peaking in Q1-2) and decrease towards the end of the year (Q4-3).

**2. Quarterly revenue and profit growth rate:**

+ The whole year: 2011 grew the fastest (average 110%), 2012 & 2013 increased slightly, however in 2014 the rate decreased (-37.8%)
...
**3. Revenue quota attainment (index =1 -> target, >1: exceeding target, <1: not meeting target)**
...
**2. By methods of approaching customers (Sale Reason)**

- The best approach is through price: 10.98 million USD, accounting for 37.6%
...
- Approach through reviews generated 1.69 million in revenue, accounting for only 5.49%
- The approach through television advertising brings a low revenue - USD 27480 accounting for only 0.1% of total revenue, the rest 0.8% is from other methods.

**3. Through special promotions**

- In the total revenue from 2011-2014, there is no revenue from incentive programs for individual customers, only programs for agents/retail stores
- Only 6.8% of revenue comes from incentive programs for agents/retailers, the remaining 93.2% is without incentives.
- In promotions for agents/retailers, quantity promotions (discount with large quantity) account for the highest percentage of revenue, followed by new product promotions.

**Recommendations**

**1. Geography evaluation (country)**

- The above analysis has shown that the US and Canada are the two most important and stable markets
+ The best-selling states in the US: California, Washington, Texas => may research to expand the market in these states, strategic products: Road Bikes, Mountain Bikes
+ The best-selling states in Canada: Ontario, British Columbia, Quebec => may research to expand the market in these states, strategic products: Road Bikes, Mountain Bikes
- Australia is the most volatile market => need to re-evaluate in detail the business situation in this region to optimize the current market share
  
**2. Time series evaluation**

- The average amount customers willing to pay for a purchase decreased from 2011 -> 2014 across all markets and all products
- Methods to increase average transaction size which focus on taking care of current customers group:
+ Focus on promoting small products with high profits
+ Sales through projects
+ Loyalty programs
+ Improve product quality, train staff, research new functions, boost new products
....
  
**3. For marketing progams and promotions:**

- Revenue without promotions accounts for a high proportion
=> This is not a bad point because factors unrelated to price incentives will be more sustainable for revenue
=> May focus on projects to improve quality, increase functions, new products to bring sustainable revenue
- The TV advertising program needs to be re-evaluated for effectiveness to improve or switch to another form of advertising
...
**1. Quy mô giao dịch trung bình:** 

Nhìn chung xét về phân tích theo sản phẩm hay theo khu vực địa lý thì đều có xu hướng giảm mạnh trong khoảng thời gian từ 2011 -> 2014 (khoảng 2210 USD/giao dịch -> 537.18 USD/giao dịch)
